...
class Engine:
    ...
    def __init__(self, model, tokenizer):
        ...
        self._model_is_trm = True if isinstance(model, TinyRecursiveModel) else False
    ...
    def generate(
        ...
        if not self._model_is_trm:
            assert kv_cache_prefill is not None
            kv_length_hint = (
